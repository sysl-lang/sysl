...
| `matrix` | an operator whose result is neither operand's type — one vector space run at four element types, one of which satisfies the bound and breaks the algorithm |
